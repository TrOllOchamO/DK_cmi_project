...
$(TARGETS): Element.o Rectangle.o Circle.o Math.o Game.o Maps.o Physics.o Player.o main.o 
	$(CXX) $(LDFLAGS) Element.o Rectangle.o Circle.o Math.o Game.o Maps.o Physics.o Player.o main.o -o $(TARGETS)
...
Game.o: Game.cc Game.hpp Element.hpp Rectangle.hpp Circle.hpp Physics.hpp Player.hpp
