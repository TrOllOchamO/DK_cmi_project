...
$(TARGETS): Element.o Rectangle.o Circle.o Math.o Game.o Maps.o Physics.o Player.o Text.o ScoreBoard.o Inputs.o Resources.o main.o
	$(CXX) $(LDFLAGS) Element.o Rectangle.o Circle.o Math.o Game.o Maps.o Physics.o Player.o Text.o ScoreBoard.o Inputs.o Resources.o main.o -o $(TARGETS)
...
Maps.o: Maps.cc Maps.hpp Rectangle.hpp Circle.hpp Text.hpp Resources.hpp
